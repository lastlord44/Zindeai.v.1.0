...
class GunlukPlanHiveModel extends HiveObject {
  ...
  GunlukPlan toEntity() {
    return GunlukPlan(
      id: id,
      tarih: tarih,
      kahvalti: kahvaltiJson != null
          ? _parseYemek(kahvaltiJson!)
          : null,
      araOgun1: araOgun1Json != null
          ? _parseYemek(araOgun1Json!)
          : null,
      ogleYemegi: ogleYemegiJson != null
          ? _parseYemek(ogleYemegiJson!)
          : null,
      araOgun2: araOgun2Json != null
          ? _parseYemek(araOgun2Json!)
          : null,
      aksamYemegi: aksamYemegiJson != null
          ? _parseYemek(aksamYemegiJson!)
          : null,
      geceAtistirma: geceAtistirmaJson != null
          ? _parseYemek(geceAtistirmaJson!)
          : null,
